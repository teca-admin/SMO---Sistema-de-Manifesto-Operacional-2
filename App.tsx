        ...
        <div className="flex items-center justify-between h-16 px-8">
          <div className="flex items-center gap-4 h-full">
            ...
            <nav className="flex h-full">
              ...
              {/* ABA EFICIÊNCIA AGORA É AMARELA QUANDO ATIVA */}
              ...
              {/* ABA AUDITORIA VOLTOU PARA O TEMA AZUL PARA DIFERENCIAR */}
              ...
              {canSeeAvaliacao && (<button onClick={() => setActiveTab('avaliacao')} className={`group flex items-center justify-center gap-2 w-32 h-16 text-[9px] font-black uppercase tracking-widest transition-all border-b-4 ${activeTab === 'avaliacao' ? 'border-indigo-400 bg-slate-800/50' : 'border-transparent text-slate-400 hover:text-white hover:bg-slate-800/30'}`}><GraduationCap size={13} className={activeTab === 'avaliacao' ? 'text-indigo-400' : 'text-slate-50'} />AVALIAÇÃO</button>)}
            </nav>
          </div>
